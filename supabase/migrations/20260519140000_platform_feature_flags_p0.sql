-- P0 Sprint 1: rollout registry (mirror of database/init/253_platform_feature_flags_p0.sql)
...
VALUES
  ...
  ('platform.correlation_middleware_v1', 'platform', 'Correlation ID middleware', true, NULL, 'global', 100, false)
