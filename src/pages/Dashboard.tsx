...
import { markDashboardReady } from "@/lib/devPerfMarks";
...
import { DashboardRevenueChartSkeleton } from "@/components/dashboard/DashboardRevenueChartSkeleton";
              ...
              {!chartShowReceived && !chartShowProjected ? (
                ...
                <Suspense fallback={<DashboardRevenueChartSkeleton />}>
                  <DashboardRevenueChart
                    chartRows={chartRows}
                    chartShowReceived={chartShowReceived}
                    chartShowProjected={chartShowProjected}
                  />
                </Suspense>
              )}
              </div>
