/**
 * Motor puro do runtime Chatbot Flows — espelho FE do backend (S7 simulador).
 * Sem I/O. Manter alinhado a packages/backend/.../flowRuntimeEngine.ts
 */
import {
...
export function processInboundStep(opts: {
  ...
  /** ID de botão/lista (simulador / UazAPI). */
  interactiveReplyId?: string | null;
  /** S32: mídia da mensagem inbound (simulador / chat_messages.media). */
