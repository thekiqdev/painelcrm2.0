...
export function OnboardingMobileShell({
  ...
  return (
    <div className="flex h-full min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
      <header
        className={cn(
          'shrink-0 border-b border-white/[0.05] bg-[hsl(228,32%,4%)]/95 px-4 backdrop-blur-xl lg:hidden',
          compactHeader
      ...
      <div
        className={cn(
          ...
          'px-4 py-3 lg:overflow-hidden lg:px-0 lg:py-0',
          reserveBottomSpace && 'pb-[min(42vh,220px)]',
        )}
      >
        {children}
      </div>
