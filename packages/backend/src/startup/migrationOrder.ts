/**
 * Ordem canónica de migrations (`database/init`).
 * Ao adicionar ficheiro novo: incluir aqui (migrate.ts e migrationGuard usam esta lista).
 */
export const MIGRATION_ORDER = [
  ...
  '269_ops_trial_engagement_columns.sql',
