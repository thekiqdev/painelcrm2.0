...
REM Verificar se node_modules existe e se vite esta instalado
if not exist "node_modules" (
...
REM Verificar se vite esta instalado
...
REM Adicionar node_modules/.bin ao PATH para executar vite
...
REM Usar npm run dev (que executa vite)
