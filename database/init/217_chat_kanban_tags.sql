-- Etapa 1 — Tags nomeadas do Kanban (tenant) + vínculo em conversas via metadata.kanban_tag_ids
-- Automação de entrada: chat_kanban_columns.metadata.automation_config.sources.tags
...
COMMENT ON TABLE public.chat_kanban_tags IS 'Tags reutilizáveis do Kanban por tenant (chat / automação)';
