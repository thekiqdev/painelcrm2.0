-- Pastas Drive por projeto (sob Cliente / Projetos / {Projeto} / Releases / {Versão}).
...
COMMENT ON TABLE public.project_google_drive_folders IS
  'IDs das pastas Drive do projeto (releases e versão ativa).';
