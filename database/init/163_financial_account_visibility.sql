-- Visibilidade por conta financeira + permissões granulares (utilizadores / equipas).
...
COMMENT ON COLUMN public.financial_accounts.visibility_mode IS
  'all_finance_users: qualquer utilizador com módulo financeiro (view); admins_only: só admins do tenant; restricted: grants em financial_account_permissions (+ admins sempre).';
