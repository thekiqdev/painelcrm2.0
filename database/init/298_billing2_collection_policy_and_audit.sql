-- Billing 2.0 Sprint 2 — Collection Policy persistida + audit append-only.
-- Aditivo / seguro: defaults iguais ao comportamento atual (S1). Sem efeito em cobrança
-- enquanto collection_policy_engine_enabled = OFF.
...
-- Seed global = defaults Sprint 1 / PRD §18 (idempotente se já existir ativa).
